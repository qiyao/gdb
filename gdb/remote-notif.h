...
/* A notification which can be queued, and processed later, such as %Stop.  */
...
void remote_notif_queued_dtr (struct notif *self);
...
extern struct notif_queued notif_packet_stop;
